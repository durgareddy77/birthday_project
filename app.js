...
// Passcode Logic
const CORRECT_PIN = "0609"; // Set your custom code here
let currentInput = "";
...
function blowCandles() {
    ...
    title.innerText = "Happy Birthday to my friend, Devi! ✨🍰";
    text.innerText = "Locked and loaded. Your wish is perfectly safe with me.";
